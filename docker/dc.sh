...
COMPOSE_OVERRIDE=
PHP_CONTAINER=php_broadway_sensitive_serializer_bundle
PHP_USER=utente
...
elif [[ "$1" == "coding-standard-fix-all" ]]; then shift 1;             ${DC_EXEC_PHP_NO_PSEUDO_TTY} $PROJECT_TOOL coding-standard-fix-all
